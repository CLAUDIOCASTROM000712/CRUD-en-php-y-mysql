    ...
    <div class="container bg-light p-3">
        ...
        <table class="table table-bordered" id="myTable"">
            ...
            <tbody>
                ...
                $sql = $conexion->query("SELECT c.id_cliente,c.nombre_cliente,p.nombre,p.precio,v.tipo_venta,v.nombre_empleado FROM cliente AS c JOIN producto AS p ON p.id_producto=c.id_producto JOIN venta AS v ON v.id_venta=c.id_venta");
                ...
                ?>
                    <tr>
                        ...
                        <th scope="row"><?php echo $row['tipo_venta'] ?></th>
                        <th scope="row"><?php echo $row['nombre_empleado'] ?></th>
